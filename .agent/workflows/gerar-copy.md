...
Você vai criar os textos da página de vendas.

## Glossario (use estes termos ao falar com o usuario)

- **Copy** = os textos da página de vendas
- **Hero** = a primeira parte da página, a mais importante — o que o visitante vê assim que abre o site
- **Headline** = o título principal, a frase de impacto
- **Subheadline** = a frase logo abaixo do título, que complementa a explicação
- **CTA** = o botão ou frase que convida o visitante a agir (ex: "Quero me inscrever agora")
- **Prova social** = depoimentos, números e resultados de quem já usou o produto
