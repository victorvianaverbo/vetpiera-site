...
A pagina completa sera criada APENAS quando o usuario usar `/desenvolver`.
...
- O usuario deve aprovar antes de prosseguir para `/desenvolver`
...
5. Sugira a proxima etapa: "Quando o design estiver aprovado, use `/desenvolver` para criar a especificacao detalhada de todas as secoes."
